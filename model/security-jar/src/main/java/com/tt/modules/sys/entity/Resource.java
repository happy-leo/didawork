...
public class Resource extends DataEntity<Resource> {
	...
	private String useable; 	// 是否在菜单中显示（1：显示；0：不显示）
	private String permission; // 权限标识
	private String type;  //菜单，还是功能按钮
	...
	@JsonIgnore
	public static void sortList(List<Resource> list, List<Resource> sourcelist, String parentId, boolean cascade){
