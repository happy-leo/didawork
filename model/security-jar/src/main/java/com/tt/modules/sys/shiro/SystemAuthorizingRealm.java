...
package com.tt.modules.sys.shiro;
...
import com.tt.common.servlet.ValidateCodeServlet;
...
//		}
		...
		if (user != null) {
			if (Global.NO.equals(user.getUseable())){
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		if (user != null) {
			...
			List<Resource> list = UserUtils.getResourceList();
